...
extern "C" {
    #[link_name = "\u{1}?ReqQueryMaxOrderVolume@Rust_CThostFtdcTraderApi@@QEAAHPEAUCThostFtdcQueryMaxOrderVolumeField@@H@Z"]
...
extern "C" {
    #[link_name = "\u{1}??_DRust_CThostFtdcTraderApi@@QEAAXXZ"]
...
extern "C" {
    #[link_name = "\u{1}??_DRust_CThostFtdcTraderSpi@@QEAAXXZ"]
...
extern "C" {
    #[link_name = "\u{1}?OnRspQueryMaxOrderVolume@Rust_CThostFtdcTraderSpi@@UEAAXPEAUCThostFtdcQueryMaxOrderVolumeField@@PEAUCThostFtdcRspInfoField@@H_N@Z"]
...
extern "C" {
    #[link_name = "\u{1}??_DRust_CThostFtdcMdApi@@QEAAXXZ"]
...
extern "C" {
    #[link_name = "\u{1}??_DRust_CThostFtdcMdSpi@@QEAAXXZ"]
